export const sanitySeedDocuments = [
  {
    _id: "siteSettings",
    _type: "siteSettings",
    siteTitle: { en: "SaudiNA Message", ar: "رسالة سعودينا" },
    siteDescription: {
    ...
    footerCopyright: { en: "© 2024 SaudiNA Fellowship. All rights reserved.", ar: "© ٢٠٢٤ زمالة سعودينا. جميع الحقوق محفوظة" },
    socialLinks: [
  ...
  },
  {
    ...
    summary: { en: "A public landing page for recovery, community, and support.", ar: "صفحة افتتاحية عامة للتعافي والمجتمع والدعم." },
    sections: [
      {
        _key: "home-hero",
        _type: "heroBlock",
